        ...
        <div class="auth-grid">
            ...
            <div class="auth-img-panel">
                ...
                <div style="position: relative; z-index: 10;">
                    ...
                    <h1 style="font-size: 3.8rem; font-weight: 800; margin-bottom: 1.5rem; line-height: 1.1; letter-spacing: -0.02em;">Join the<br>Elite Circle.</h1>
                    <p style="font-size: 1.25rem; opacity: 0.85; max-width: 450px; line-height: 1.6; font-weight: 300;">Unlock exclusive access to Ethiopia's most prestigious properties and high-end hospitality services.</p>
                </div>
            </div>
            ...
            <div class="auth-form-panel">
                <div style="width: 100%; max-width: 440px;">
                    <div style="margin-bottom: 3rem;">
                        <h2 style="font-size: 2.2rem; color: var(--color-secondary); font-weight: 800; margin-bottom: 0.75rem;">Create Account</h2>
                        <p style="color: var(--color-text-light); font-size: 1.05rem;">Enter your details to start your journey.</p>
                    </div>

                    <form onsubmit="event.preventDefault(); window.handleSignup();">
                        <div style="display: grid; gap: 1.5rem;">
                            <div class="form-group" style="max-width: 100%;">
                                <label style="display: block; font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; color: var(--color-secondary); margin-bottom: 0.6rem;">Full Legal Name</label>
                            ...
                            <div class="form-group" style="max-width: 100%;">
                                <label style="display: block; font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; color: var(--color-secondary); margin-bottom: 0.6rem;">Email Address</label>
                                <input type="email" id="signup-email" required placeholder="email@domain.com" 
                                    style="width:100%; box-sizing: border-box; border: 2px solid #f0f0f0; border-radius: 12px; padding: 1.1rem; font-size: 1rem; background: #f9f9f9;">
                            </div>

                            <div class="form-group" style="max-width: 100%;">
                                <label style="display: block; font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; color: var(--color-secondary); margin-bottom: 0.6rem;">Password</label>
                    ...
                    <p style="text-align: center; margin-top: 2.5rem; color: #666; font-size: 1rem;">
                        Already joined? <a href="#" onclick="event.preventDefault(); window.router.navigate('login')" 
                            style="color: var(--color-primary); font-weight: 800; text-decoration: none; border-bottom: 2px solid var(--color-primary-light);">Sign In</a>
                    </p>
                </div>
            </div>
        </div>
